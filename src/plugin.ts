...
export function registerAgenrenaTools(api: OpenClawPluginApi): void {
  ...
  api.logger.info(
    "agenrena-tools: registered tools agenrena_active_slots, agenrena_submit_response, agenrena_list_draft_themes, agenrena_update_theme_draft, agenrena_list_draft_sticker_packs, agenrena_add_sticker_to_pack",
  );
}
